    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .icon-pill {
            padding: 8px 14px;
            border-radius: 999px;
            border: 1px solid rgba(3, 172, 14, 0.18);
            background: #ffffff;
            font-weight: 600;
            color: var(--accent-dark);
            text-decoration: none;
        ...
        .icon-pill:hover { background: rgba(3, 172, 14, 0.08); }
        .icon-pill.primary {
            border: none;
            background: linear-gradient(135deg, #03ac0e, #02a30d);
            color: #ffffff;
            box-shadow: 0 12px 22px rgba(3, 172, 14, 0.18);
        }
        .icon-pill.primary:hover { box-shadow: 0 14px 26px rgba(3, 172, 14, 0.24); }
        ...
        <div class="content">
            <div class="page-title">
                <div>
                    ...
                    <p>Lengkapi detail produk agar pelanggan mudah menemukan barang Anda.</p>
                </div>
            </div>
            <div class="card">
                <?php if ($message): ?>
                ...
                <form class="form-grid" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            ...
                            <small style="color: var(--text-muted); font-size: 13px;">Gunakan deskripsi singkat yang informatif dan menarik.</small>
                        </div>
                    </div>
                    <div class="field">
                        <label for="price">Harga</label>
                        <div class="control">
                            <input type="number" step="0.01" id="price" name="price" value="<?= htmlspecialchars($priceInput) ?>" required>
                        </div>
                    </div>
                    <div class="field">
                        ...
                        <div class="control">
                            ...
                            <small style="color: var(--text-muted); font-size: 13px;">Format yang didukung: JPG, JPEG, PNG, atau WEBP.</small>
                        </div>
                    </div>
                    <div class="actions">
                        <button type="submit" name="submit" class="primary-btn">Simpan Produk</button>
                    </div>
                </form>
            </div>
        </div>
